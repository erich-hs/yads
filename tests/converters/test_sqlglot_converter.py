...
def test_create_table_with_interval_year():
    """
    Tests creating a table with an INTERVAL YEAR column.
    """
    spec_yaml = """
name: "my_catalog.my_db.my_table"
version: "1.0"
columns:
  - name: "my_interval"
    ...
    params:
      interval_start: "year"
"""
    sql = "CREATE TABLE my_catalog.my_db.my_table (my_interval INTERVAL YEAR)"
    assert_ast_equal(spec_yaml, sql)


def test_create_table_with_interval_month():
    """
    Tests creating a table with an INTERVAL MONTH column.
    """
    spec_yaml = """
name: "my_catalog.my_db.my_table"
version: "1.0"
...
"""
    sql = "CREATE TABLE my_catalog.my_db.my_table (my_interval INTERVAL MONTH)"
    assert_ast_equal(spec_yaml, sql)


def test_create_table_with_interval_year_to_month():
    """
    Tests creating a table with an INTERVAL YEAR TO MONTH column.
    """
    spec_yaml = """
name: "my_catalog.my_db.my_table"
version: "1.0"
columns:
  - name: "my_interval"
    ...
    params:
      ...
      interval_end: "month"
"""
    sql = "CREATE TABLE my_catalog.my_db.my_table (my_interval INTERVAL YEAR TO MONTH)"
    assert_ast_equal(spec_yaml, sql)


def test_create_table_with_interval_day():
    """
    Tests creating a table with an INTERVAL DAY column.
    """
    spec_yaml = """
name: "my_catalog.my_db.my_table"
version: "1.0"
columns:
  - name: "my_interval"
    ...
    params:
      interval_start: "day"
"""
    sql = "CREATE TABLE my_catalog.my_db.my_table (my_interval INTERVAL DAY)"
    assert_ast_equal(spec_yaml, sql)


def test_create_table_with_interval_hour():
    """
    Tests creating a table with an INTERVAL HOUR column.
    """
    spec_yaml = """
name: "my_catalog.my_db.my_table"
version: "1.0"
columns:
  - name: "my_interval"
    ...
    params:
      interval_start: "hour"
"""
    sql = "CREATE TABLE my_catalog.my_db.my_table (my_interval INTERVAL HOUR)"
    assert_ast_equal(spec_yaml, sql)


def test_create_table_with_interval_minute():
    """
    Tests creating a table with an INTERVAL MINUTE column.
    """
    spec_yaml = """
name: "my_catalog.my_db.my_table"
version: "1.0"
...
"""
    sql = "CREATE TABLE my_catalog.my_db.my_table (my_interval INTERVAL MINUTE)"
    assert_ast_equal(spec_yaml, sql)


def test_create_table_with_interval_second():
    """
    Tests creating a table with an INTERVAL SECOND column.
    """
    spec_yaml = """
name: "my_catalog.my_db.my_table"
version: "1.0"
...
"""
    sql = "CREATE TABLE my_catalog.my_db.my_table (my_interval INTERVAL SECOND)"
    assert_ast_equal(spec_yaml, sql)


def test_create_table_with_interval_day_to_hour():
    """
    Tests creating a table with an INTERVAL DAY TO HOUR column.
    """
    spec_yaml = """
name: "my_catalog.my_db.my_table"
version: "1.0"
columns:
  - name: "my_interval"
    ...
    params:
      ...
      interval_end: "hour"
"""
    sql = "CREATE TABLE my_catalog.my_db.my_table (my_interval INTERVAL DAY TO HOUR)"
    assert_ast_equal(spec_yaml, sql)


def test_create_table_with_interval_day_to_minute():
    """
    Tests creating a table with an INTERVAL DAY TO MINUTE column.
    """
    spec_yaml = """
name: "my_catalog.my_db.my_table"
version: "1.0"
columns:
  - name: "my_interval"
    ...
    params:
      ...
      interval_end: "minute"
"""
    sql = "CREATE TABLE my_catalog.my_db.my_table (my_interval INTERVAL DAY TO MINUTE)"
    assert_ast_equal(spec_yaml, sql)


def test_create_table_with_interval_day_to_second():
    """
    Tests creating a table with an INTERVAL DAY TO SECOND column.
    """
    spec_yaml = """
name: "my_catalog.my_db.my_table"
version: "1.0"
columns:
  - name: "my_interval"
    ...
    params:
      ...
      interval_end: "second"
"""
    sql = "CREATE TABLE my_catalog.my_db.my_table (my_interval INTERVAL DAY TO SECOND)"
    assert_ast_equal(spec_yaml, sql)


def test_create_table_with_interval_hour_to_minute():
    """
    Tests creating a table with an INTERVAL HOUR TO MINUTE column.
    """
    spec_yaml = """
name: "my_catalog.my_db.my_table"
version: "1.0"
columns:
  - name: "my_interval"
    ...
    params:
      ...
      interval_end: "minute"
"""
    sql = "CREATE TABLE my_catalog.my_db.my_table (my_interval INTERVAL HOUR TO MINUTE)"
    assert_ast_equal(spec_yaml, sql)


def test_create_table_with_interval_hour_to_second():
    """
    Tests creating a table with an INTERVAL HOUR TO SECOND column.
    """
    spec_yaml = """
name: "my_catalog.my_db.my_table"
version: "1.0"
columns:
  - name: "my_interval"
    ...
    params:
      ...
      interval_end: "second"
"""
    sql = "CREATE TABLE my_catalog.my_db.my_table (my_interval INTERVAL HOUR TO SECOND)"
    assert_ast_equal(spec_yaml, sql)


def test_create_table_with_interval_minute_to_second():
    """
    Tests creating a table with an INTERVAL MINUTE TO SECOND column.
    """
    spec_yaml = """
name: "my_catalog.my_db.my_table"
version: "1.0"
...
"""
    sql = (
        "CREATE TABLE my_catalog.my_db.my_table (my_interval INTERVAL MINUTE TO SECOND)"
    )
    assert_ast_equal(spec_yaml, sql)
